...
public class PostServiceImpl implements PostService {
	...
	@Override
	@CacheEvict(value = { "posts", "post", "postsByCategory", "postsByUser", "postsSearch" }, allEntries = true)
	...
	@Override
	@Cacheable(cacheNames = "postsByCategory", key = "#categoryId + '_' + #pageNumber + '_' + #pageSize")
	...
	@Override
	@Cacheable(cacheNames = "postsSearch", key = "#keyword")
	...
	// Pagination
	@Override
	@Cacheable(cacheNames = "posts", key = "#pageNumber + '_' + #pageSize + '_' + #sortBy + '_' + #sortDir")
